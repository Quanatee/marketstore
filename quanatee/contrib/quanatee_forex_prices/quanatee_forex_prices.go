	...
	for bar := 0; bar < numrows; bar++ {
        ...
        if (( int(from.UTC().Weekday()) == 0 && from.UTC().Hour() >= 22 ) || 
            ...
            if dt.UTC().Unix() > last.UTC().Unix() && dt.UTC().Unix() >= from.UTC().Unix() && dt.UTC().Unix() <= to.UTC().Unix() {
                ...
                if forexData.PriceData[bar].Open != 0 && forexData.PriceData[bar].High != 0 && forexData.PriceData[bar].Low != 0 && forexData.PriceData[bar].Close != 0 {
                    endOfSlice = bar
	...
	for bar := 0; bar < numrows; bar++ {
        ...
        if ((( int(from.UTC().Weekday()) == 0 && from.UTC().Hour() >= 22 ) || 
            ...
            if dt.UTC().Unix() > last.UTC().Unix() && dt.UTC().Unix() >= from.UTC().Unix() && dt.UTC().Unix() <= to.UTC().Unix() {
                ...
                if forexData[bar].Open != 0 && forexData[bar].High != 0 && forexData[bar].Low != 0 && forexData[bar].Close != 0 {
                    endOfSlice = bar
                    quote.Epoch[bar] = dt.UTC().Unix()
